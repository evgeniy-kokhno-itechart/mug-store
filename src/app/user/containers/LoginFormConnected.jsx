...
import { FormBase } from '../../shared';
import { LoginForm } from '../components/LoginForm';
import ErrorMessage from '../../shared/components/markup/ErrorMessage';
  ...
  renderForm = () => {
    ...
    return (
      <React.Fragment>
        ...
        {loginError && <ErrorMessage message={loginError} customClasses='d-flex justify-content-center h4 mt-3' />}
      </React.Fragment>
    );
  }

...
export function saveProduct(product) {
  const productInDb = products.find(m => m._id === product._id) || {};
  productInDb.title = product.title;
  productInDb.imageURL = product.imageURL;
  productInDb.category = categoriesAPI.categories.find(c => c._id === product.categoryId);
...
export function deleteProduct(id) {
  const productInDb = products.find(m => m._id === id);
